    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('load') ? 'is-invalid' : '' }}" type="text" name="load" id="load" value="{{ old('load', $product->load) }}">
                @if($errors->has('load'))
                    <div class="invalid-feedback">
                        {{ $errors->first('load') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('speed') ? 'is-invalid' : '' }}" type="text" name="speed" id="speed" value="{{ old('speed', $product->speed) }}">
                @if($errors->has('speed'))
                    <div class="invalid-feedback">
                        {{ $errors->first('speed') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_stop') ? 'is-invalid' : '' }}" type="text" name="max_stop" id="max_stop" value="{{ old('max_stop', $product->max_stop) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_rise') ? 'is-invalid' : '' }}" type="text" name="max_rise" id="max_rise" value="{{ old('max_rise', $product->max_rise) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_available') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_available" id="is_available" value="1" {{ $product->is_available || old('is_available', 0) === 1 ? 'checked' : '' }}>
