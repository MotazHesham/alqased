<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('clients_review_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.clients-reviews.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/clients-reviews") || request()->is("admin/clients-reviews/*") ? "c-active" : "" }}">
        ...
        @can('general_setting_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/settings*") ? "c-show" : "" }} {{ request()->is("admin/sliders*") ? "c-show" : "" }} {{ request()->is("admin/work-locations*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @endcan
                    @can('work_location_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.work-locations.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/work-locations") || request()->is("admin/work-locations/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-globe c-sidebar-nav-icon">

                                </i>
                                {{ trans('cruds.workLocation.title') }}
                            </a>
                        </li>
                    @endcan
                </ul>
